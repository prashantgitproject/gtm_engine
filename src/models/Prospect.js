...
const dripStepSchema = new Schema(
  {
    day: { type: Number, required: true, min: 1, max: 90 },
    channel: {
      type: String,
    ...
    /** Local delivery time (hour 0–23) on the scheduled calendar day; default 11 at launch. */
    deliveryHour: { type: Number, min: 0, max: 23 },
...
const prospectSchema = new Schema(
  {
    ...
    /**
     * Personalized drip sequence (email, LinkedIn, WhatsApp) — generated by LLM, editable in UI.
     */
    dripSequence: { type: [dripStepSchema], default: [] },
    dripGeneratedAt: { type: Date },

    /** Outreach execution after campaign launch */
    outreachStatus: {
      type: String,
      enum: ["idle", "enrolled", "completed", "paused"],
      default: "idle",
    },
    outreachEnrolledAt: { type: Date },
  },
  { timestamps: true }
);
...
prospectSchema.index(
  { campaign: 1, outreachStatus: 1 },
  { partialFilterExpression: { outreachStatus: "enrolled" } }
);
